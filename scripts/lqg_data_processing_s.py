...
for n_episodes in [2,5,10,20]:
    ...
    ite_comp=601
    m=10
    _filter_par = np.arange(0, ite_comp, (ite_comp-1)/10)
    _filter_knn = np.arange(0, 201, 20)
    ...
    comp_labels[2] = 'GIRL - absolute value'
    ...
    if plot:
        ...
        for i in range(comp_mean.shape[0]):
            ...
            ax.errorbar(_range[_filter_par], y[_filter_par],
                        yerr=[y_lower[_filter_par], y_upper[_filter_par]],
        ...
        for i in range(comp_mean.shape[0]):
            ...
            ax.errorbar(_range[_filter_knn], y[_filter_knn],
                        yerr=[y_lower[_filter_knn], y_upper[_filter_knn]],
                        marker='+', label=comp_labels[i])
