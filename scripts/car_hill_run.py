...
policy = RBFGaussianPolicy(centers, parameters, sigma=0.1, radial_basis_parameters=1.)

#DA SISTEMARE
ml_policy = fit_maximum_likelihood_policy_from_trajectories(trajectories_expert,
                                                            policy,
                                                            parameters,
...
print('ML policy return %s' % np.dot(trajectories_ml[:, 3], trajectories_ml[:, 6]))
